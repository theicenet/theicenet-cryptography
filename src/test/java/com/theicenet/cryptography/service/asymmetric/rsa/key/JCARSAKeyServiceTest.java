...
class JCARSAKeyServiceTest {
  ...
  final int _1024_KEY_LENGTH = 1024;
  ...
  void producesNotNullKeyPairWhenGeneratingKey() {
    // When
    final var generatedKeyPair = rsaKeyService.generateKey(_1024_KEY_LENGTH);
  ...
  @Test
  void producesPublicKeyWithTheRightModulusLengthWhenGeneratingKey() throws Exception {
    // When
    final var generatedKeyPair = rsaKeyService.generateKey(_1024_KEY_LENGTH);
    ...
    assertThat(rsaPublicKey.getModulus().bitLength(), is(equalTo(_1024_KEY_LENGTH)));
  }

  @Test
  void producesPrivateKeyWithTheRightModulusLengthWhenGeneratingKey() throws Exception {
    // When
    final var generatedKeyPair = rsaKeyService.generateKey(_1024_KEY_LENGTH);
    ...
    assertThat(rsaPrivateKey.getModulus().bitLength(), is(equalTo(_1024_KEY_LENGTH)));
  }
  ...
  void producesDifferentPublicKeysWhenGeneratingTwoConsecutiveKeysWithTheSameLength() {
    ...
    final var generatedKeyPair_1 = rsaKeyService.generateKey(_1024_KEY_LENGTH);
    final var generatedKeyPair_2 = rsaKeyService.generateKey(_1024_KEY_LENGTH);
  ...
  void producesDifferentPublicKeysWhenGeneratingManyConsecutiveKeysWithTheSameLength() {
    ...
    final var generatePublicKeys =
        IntStream
            .range(0, _100)
            .mapToObj(index -> rsaKeyService.generateKey(_1024_KEY_LENGTH))
    ...
    IntStream
        ...
        .forEach(index ->
            executorService.execute(() -> {
              ...
              final var keyPair = rsaKeyService.generateKey(_1024_KEY_LENGTH);
