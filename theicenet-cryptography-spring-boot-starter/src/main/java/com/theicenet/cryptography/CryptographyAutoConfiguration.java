...
public class CryptographyAutoConfiguration {
  ...
  public PBKDKeyService pbkdKeyArgon2Service(
    ...
    return new PBKDArgon2Service(new Argon2Configuration(type, version, iterations, memoryPowOfTwo, parallelism));
  }
  ...
  public PBKDKeyService pbkdKeySCryptService(
    ...
    return new PBKDSCryptService(new SCryptConfiguration(cpuMemoryCost, blockSize, parallelization));
  }
